...
- Se requiere cuenta activa para poder agendar una cita
- El pago es 100% adelantado — sin anticipo parcial, se paga el total al momento de reservar

### Política de cancelación
- El cliente puede cancelar su cita con mínimo **1 día de anticipación**
- Si el cliente no cancela con tiempo o no se presenta, **pierde el dinero** (sin reembolso)

### Restricciones
- Un usuario solo puede tener **1 cita reservada a la vez**

### Profesionales y agendas
- Número de técnicas que trabajan: sin definir — preguntar a Liz
- Si cada técnica tiene su propia agenda: sin definir — preguntar a Liz
...
Users must create an account to book.

Appointments must be paid online.

Cancellation policy:

Users must cancel at least 24 hours before.

If not cancelled in time:
appointment is lost and payment is not refunded.