...
Cohesion: 0.05
Nodes (63): escapeHtml(), formatInline(), headingLevel(), renderMarkdownToSafeHtml(), RendererRegistry, resolveManifest(), normalizeScreenshotPath(), resolveAppConfig() (+55 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (66): collectProcessTreePids(), commandArgs(), createCommandInvocation(), createLoggedStdio(), createProcessStampArgs(), isProcessAlive(), listPosixProcessSnapshots(), listProcessSnapshots() (+58 more)
...
Cohesion: 0.08
Nodes (29): attachParentMonitor(), createWebDiscovery(), runDesktopMain(), createDesktopRuntime(), createPendingHtml(), installWindowChromeCssHook(), showWindowButtons(), main() (+21 more)
...
Cohesion: 0.15
Nodes (26): GET(), mapAuthStatus(), POST(), GET(), mapAuthStatus(), POST(), GET(), mapResultStatus() (+18 more)

### Community 19 - "Community 19"
Cohesion: 0.1
Nodes (25): daemonIsLive(), fetchAgents(), fetchDesignSystems(), fetchProjectFiles(), fetchSkill(), fetchSkills(), hasAnyConfiguredProvider(), loadConfig() (+17 more)
...
Cohesion: 0.18
Nodes (18): errorResponse(), POST(), AdminCourseRegistrationsPage(), assertAdmin(), errorResponse(), GET(), POST(), addManualRegistration() (+10 more)
...
Cohesion: 0.16
Nodes (11): AcademiaPage(), AdminCoursesPage(), assertAdmin(), errorResponse(), GET(), POST(), CursosPage(), createCourse() (+3 more)
...
Cohesion: 0.23
Nodes (12): assertAdmin(), DELETE(), errorResponse(), mapResultStatus(), mapResultToStatus(), PATCH(), deleteAdminBrand(), deleteAdminCategory() (+4 more)

### Community 36 - "Community 36"
Cohesion: 0.18
Nodes (11): errorResponse(), POST(), errorResponse(), PATCH(), GET(), requireAdminOrReceptionist(), createClientFromAdmin(), createBlockedSlot() (+3 more)
...
- **Why does `createClient()` connect `Community 25` to `Community 64`, `Community 35`, `Community 36`, `Community 5`, `Community 6`, `Community 7`, `Community 40`, `Community 41`, `Community 14`, `Community 15`, `Community 18`, `Community 21`, `Community 55`, `Community 24`, `Community 31`?**
  _High betweenness centrality (0.265) - this node is a cross-community bridge._
- **Why does `extractSwatches()` connect `Community 52` to `Community 6`?**
