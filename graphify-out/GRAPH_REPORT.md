# Graph Report - liz-cabriales  (2026-06-22)

## Corpus Check
- 355 files · ~229,823 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2751 nodes · 5018 edges · 115 communities detected
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 551 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cf134b7f`
...
- `GET()` --calls--> `requireAdmin()`  [INFERRED]
  app/api/admin/announcements/route.ts → lib/supabase/admin.ts
...
Cohesion: 0.06
Nodes (83): isToolDevAppName(), parsePortOption(), resolveRunApps(), resolveStartApps(), resolveStopApps(), resolveTargetApps(), unsupportedAppError(), appendStartupLogDiagnostics() (+75 more)
...
Cohesion: 0.05
Nodes (35): computeInvoiceSurchargeMxn(), roundMoney(), errorResponse(), POST(), OrdenPage(), errorResponse(), GET(), mapErrorStatus() (+27 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (46): errorResponse(), POST(), buildExternalRef(), errorResponse(), POST(), AdminCoursesPage(), assertAdmin(), errorResponse() (+38 more)

### Community 6 - "Community 6"
Cohesion: 0.07
Nodes (44): buildExternalRef(), errorResponse(), POST(), AdminAppointmentsPage(), assertAdminOrReceptionist(), errorResponse(), GET(), POST() (+36 more)
...
Cohesion: 0.11
Nodes (32): resolveAppConfig(), resolveElectronBinaryPath(), resolveToolDevConfig(), resolveTsxCliPath(), allocateDynamicPort(), allocateForcedPort(), allocatePort(), assertMatchingEnv() (+24 more)
...
Cohesion: 0.13
Nodes (21): GET(), mapStatus(), POST(), assertAdmin(), GET(), PUT(), POST(), mapStatus() (+13 more)

### Community 21 - "Community 21"
Cohesion: 0.15
Nodes (24): GET(), mapAuthStatus(), POST(), GET(), mapAuthStatus(), POST(), categoryFromJoin(), createAdminBrand() (+16 more)

### Community 22 - "Community 22"
Cohesion: 0.09
Nodes (12): buildBrandsCategory(), withBrandsCategory(), clearMenuCloseTimer(), closeCart(), closeSearchPanels(), handleMouseLeavePage(), handleSearchSubmit(), openDesktopMenu() (+4 more)
...
Cohesion: 0.14
Nodes (21): commandArgs(), createCommandInvocation(), createLoggedStdio(), createProcessStampArgs(), isProcessAlive(), listPosixProcessSnapshots(), listProcessSnapshots(), listWindowsProcessSnapshots() (+13 more)
...
Cohesion: 0.11
Nodes (18): DesignSystemPreviewModal(), daemonIsLive(), fetchAgents(), fetchAppVersionInfo(), fetchDesignSystemPreview(), fetchDesignSystems(), fetchDesignSystemShowcase(), fetchProjectFilePreview() (+10 more)
...
Cohesion: 0.14
Nodes (15): errorResponse(), PATCH(), POST(), errorResponse(), PATCH(), escapeIlikePattern(), GET(), normalizeSearchQuery() (+7 more)
...
Cohesion: 0.24
Nodes (7): attachParentMonitor(), createWebDiscovery(), runDesktopMain(), createDesktopRuntime(), createPendingHtml(), installWindowChromeCssHook(), showWindowButtons()
...
Cohesion: 0.31
Nodes (9): normalizeScreenshotPath(), pathExists(), readJsonIfExists(), readPackagedConfig(), readRawPackagedConfig(), resolveDefaultConfigPath(), resolveOptionalPath(), resolveProjectRoot() (+1 more)
...
Cohesion: 0.36
Nodes (8): GET(), mapStatus(), POST(), createAdminSubcategory(), ensureUniqueSubcategorySlug(), getAdminSubcategoriesWithProductCount(), slugifySubcategory(), updateAdminSubcategory()
...
Cohesion: 0.43
Nodes (6): GET(), mapResultStatus(), POST(), getAdminCategories(), getAdminProducts(), searchProductsForNailArt()
...
Cohesion: 0.83
Nodes (3): mapResultStatus(), POST(), bulkUpdateProductsDiscount()
...
- **Why does `createClient()` connect `Community 40` to `Community 69`, `Community 7`, `Community 73`, `Community 50`, `Community 19`, `Community 116`, `Community 24`, `Community 90`?**
  _High betweenness centrality (0.309) - this node is a cross-community bridge._
- **Why does `pick()` connect `Community 116` to `Community 86`?**
  _High betweenness centrality (0.290) - this node is a cross-community bridge._
- **Why does `extractSwatches()` connect `Community 86` to `Community 116`?**
  _High betweenness centrality (0.290) - this node is a cross-community bridge._
