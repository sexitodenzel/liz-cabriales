# Graph Report - liz-cabriales  (2026-07-02)

## Corpus Check
- 384 files · ~245,472 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2883 nodes · 5191 edges · 123 communities detected
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 560 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c6084dcd`
...
- `handleChange()` --calls--> `compressImage()`  [INFERRED]
  app/admin/components/ImageUploader.tsx → lib/image-compress.ts
...
- `handleFileChange()` --calls--> `compressImage()`  [INFERRED]
  app/admin/media/page.tsx → lib/image-compress.ts

## Communities (321 total, 22 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.07
Nodes (80): errorResponse(), GET(), tomorrowInTampicoTz(), adminBadge(), send(), sendAdminAppointmentCancelledEmail(), sendAdminNewAppointmentEmail(), sendAdminNewCourseRegistrationEmail() (+72 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (81): isToolDevAppName(), parsePortOption(), resolveElectronBinaryPath(), resolveRunApps(), resolveStartApps(), resolveStopApps(), resolveTargetApps(), resolveTsxCliPath() (+73 more)
...
Cohesion: 0.06
Nodes (49): errorResponse(), POST(), buildExternalRef(), errorResponse(), POST(), AdminCoursesPage(), assertAdmin(), errorResponse() (+41 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (38): buildSpreadsheetXml(), cell(), escapeXml(), exportProductsToXls(), cancelEditing(), clearSelection(), confirmDelete(), fetchBrands() (+30 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (32): computeInvoiceSurchargeMxn(), roundMoney(), errorResponse(), POST(), OrdenPage(), errorResponse(), GET(), mapErrorStatus() (+24 more)

### Community 6 - "Community 6"
Cohesion: 0.07
Nodes (41): buildExternalRef(), errorResponse(), POST(), AdminAppointmentsPage(), assertAdminOrReceptionist(), errorResponse(), GET(), POST() (+33 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (29): getSearchDestination(), isStrongCategoryMatch(), getSiteShellLayout(), buildBrandsCategory(), withBrandsCategory(), handleSubmit(), animateNavBarTo(), applyNavBarStyle() (+21 more)
...
Cohesion: 0.07
Nodes (29): AcademiaPage(), mapRow(), normalizeAbrasivity(), unwrap(), NuevosLanzamientos(), isAbrasivityValue(), CursosPage(), generateMetadata() (+21 more)
...
Cohesion: 0.13
Nodes (18): assertAdmin(), DELETE(), errorResponse(), getAuth(), mapResultStatus(), mapResultToStatus(), mapStatus(), PATCH() (+10 more)

### Community 17 - "Community 17"
Cohesion: 0.12
Nodes (31): resolveAppConfig(), resolveToolDevConfig(), allocateDynamicPort(), allocateForcedPort(), allocatePort(), assertMatchingEnv(), bootstrapSidecarRuntime(), closeServer() (+23 more)
...
Cohesion: 0.14
Nodes (27): GET(), mapAuthStatus(), POST(), GET(), mapStatus(), POST(), categoryFromJoin(), createAdminBrand() (+19 more)
...
Cohesion: 0.12
Nodes (22): mapResultStatus(), POST(), assertAdmin(), GET(), PUT(), assertAdmin(), GET(), PUT() (+14 more)

### Community 23 - "Community 23"
Cohesion: 0.12
Nodes (18): errorResponse(), POST(), errorResponse(), PATCH(), POST(), errorResponse(), PATCH(), escapeIlikePattern() (+10 more)

### Community 24 - "Community 24"
Cohesion: 0.13
Nodes (23): commandArgs(), createCommandInvocation(), createLoggedStdio(), createPackageManagerInvocation(), createProcessStampArgs(), isProcessAlive(), listPosixProcessSnapshots(), listProcessSnapshots() (+15 more)
...
Cohesion: 0.13
Nodes (18): createArtifactParser(), findOpenTag(), parseAttrs(), fetchDesignSystem(), fetchProjectFiles(), fetchSkill(), createConversation(), createProject() (+10 more)
...
Cohesion: 0.16
Nodes (10): handleSubscribeClick(), clear(), clearTimer(), emit(), internalDismiss(), push(), scheduleDismiss(), subscribe() (+2 more)

### Community 41 - "Community 41"
Cohesion: 0.12
Nodes (5): useHoverCapable(), cn(), Magnetic(), Marquee(), TiltCard()
...
Cohesion: 0.13
Nodes (5): handleChange(), compressImage(), handleFileChange(), AnimatedBadge(), handleCoverUpload()
...
Cohesion: 0.17
Nodes (13): resolveElectronBuilderCliPath(), resolveElectronDistPath(), resolveElectronVersion(), resolveToolPackBuildOutput(), resolveToolPackConfig(), addSharedOptions(), readPackedMacLogs(), desktopLogPath() (+5 more)
...
Cohesion: 0.27
Nodes (13): buildCreateAccountHref(), buildPostAuthRedirect(), handleGoogleLogin(), handleLogin(), handleRegister(), handleSkipOtp(), handleSubmit(), handleVerifyOtp() (+5 more)
...
Cohesion: 0.16
Nodes (4): AddToCartButton(), applyDiscount(), clampDiscountPercent(), hasDiscount()
...
Cohesion: 0.19
Nodes (9): DesignSystemPreviewModal(), deleteProjectFile(), fetchAppVersionInfo(), fetchDesignSystemPreview(), fetchDesignSystemShowcase(), fetchProjectFileText(), isAppVersionInfo(), projectFileUrl() (+1 more)
...
Cohesion: 0.18
Nodes (5): handleSelectColorAndSize(), handleSelectSize(), AccountQuickStats(), WishlistPage(), useWishlist()
...
Cohesion: 0.26
Nodes (10): GET(), mapAuthStatus(), POST(), GET(), mapResultStatus(), POST(), getAdminCategories(), getAdminCategoriesWithProductCount() (+2 more)

### Community 68 - "Community 68"
Cohesion: 0.22
Nodes (6): escapeHtml(), formatInline(), headingLevel(), renderMarkdownToSafeHtml(), RendererRegistry, resolveManifest()
...
Cohesion: 0.38
Nodes (10): buildOrderConfirmationHtml(), dottedDivider(), escapeHtml(), formatDateTime(), formatPrice(), renderDeliverySection(), renderItem(), renderItemRow() (+2 more)
...
Cohesion: 0.4
Nodes (7): buildSupabaseOrFilter(), normalizeSearchText(), scoreSearchMatch(), tokenizeSearchQuery(), GET(), scoreProduct(), tokenize()
...
Cohesion: 0.33
Nodes (5): AdminPage(), GET(), getAdminDashboardStats(), getLowStockVariants(), unwrapProduct()
...
Cohesion: 0.32
Nodes (4): clamp(), computeTarget(), evaluate(), update()

### Community 95 - "Community 95"
Cohesion: 0.36
Nodes (6): clearError(), handleSendCode(), handleSubmit(), validate(), validateBirthDate(), normalizePhoneInput()

### Community 97 - "Community 97"
Cohesion: 0.39
Nodes (5): addImage(), addVideo(), isValidVideoUrl(), uid(), ytThumb()

### Community 100 - "Community 100"
Cohesion: 0.46
Nodes (6): GET(), mapStatus(), PATCH(), getAnnouncementBarEnabled(), parseEnabledValue(), setAnnouncementBarEnabled()
...
- **Why does `createClient()` connect `Community 48` to `Community 98`, `Community 4`, `Community 40`, `Community 44`, `Community 79`, `Community 50`, `Community 51`, `Community 27`, `Community 127`, `Community 95`?**
  _High betweenness centrality (0.335) - this node is a cross-community bridge._
- **Why does `pick()` connect `Community 127` to `Community 92`?**
  _High betweenness centrality (0.294) - this node is a cross-community bridge._
- **Why does `extractSwatches()` connect `Community 92` to `Community 127`?**
  _High betweenness centrality (0.294) - this node is a cross-community bridge._
- **Are the 44 inferred relationships involving `requireAdmin()` (e.g. with `GET()` and `POST()`) actually correct?**
  _`requireAdmin()` has 44 INFERRED edges - model-reasoned connections that need verification._
