# Graph Report - liz-cabriales  (2026-06-16)

## Corpus Check
- 246 files · ~184,338 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2350 nodes · 4446 edges · 98 communities detected
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 498 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `06c901aa`
...
2. `requireAdmin()` - 57 edges
3. `getResend()` - 37 edges
4. `shortId()` - 36 edges
5. `buildEmailShell()` - 35 edges
6. `POST()` - 32 edges
7. `formatPriceMXN()` - 22 edges
8. `requireAdminOrReceptionist()` - 21 edges
9. `renderDesignSystemShowcase()` - 21 edges
10. `generateMedia()` - 20 edges
...
Cohesion: 0.05
Nodes (88): inferLegacyManifest(), isPlainObject(), parsePersistedManifest(), sanitizeManifest(), validateArtifactManifestInput(), validateBoundedString(), validateSupportingPath(), chooseEntryFile() (+80 more)
...
Cohesion: 0.05
Nodes (48): AcademiaPage(), errorResponse(), POST(), buildExternalRef(), errorResponse(), POST(), AdminCoursesPage(), assertAdmin() (+40 more)
...
Cohesion: 0.13
Nodes (31): appendNsisLog(), buildWorkspaceArtifacts(), collectWorkspaceTarballs(), copyResourceTree(), copyWinIcon(), desktopLogPath(), desktopStamp(), ensureNsisPersianLanguageAlias() (+23 more)
...
Cohesion: 0.1
Nodes (10): RootLayout(), CartProvider(), clearGuestCart(), computeItemCount(), computeSubtotal(), mergeCartItems(), readGuestCart(), writeGuestCart() (+2 more)
...
Cohesion: 0.17
Nodes (21): GET(), mapAuthStatus(), POST(), mapAuthStatus(), POST(), categoryFromJoin(), createAdminBrand(), createAdminCategory() (+13 more)
...
Cohesion: 0.15
Nodes (16): errorResponse(), POST(), errorResponse(), PATCH(), errorResponse(), PATCH(), escapeIlikePattern(), GET() (+8 more)
...
Cohesion: 0.18
Nodes (16): assertAdmin(), GET(), PUT(), POST(), POST(), createAdminProductVariant(), deleteAdminProductVariant(), getAdminProductVariants() (+8 more)

### Community 31 - "Community 31"
Cohesion: 0.15
Nodes (13): GET(), NuevosLanzamientos(), generateMetadata(), getBlockedSlotsForDate(), getBrands(), getCategories(), getFeaturedProducts(), getProductBySlug() (+5 more)
...
Cohesion: 0.25
Nodes (12): assertAdmin(), DELETE(), errorResponse(), getAuth(), mapResultStatus(), mapResultToStatus(), PATCH(), deleteAdminCategory() (+4 more)

### Community 37 - "Community 37"
Cohesion: 0.11
Nodes (4): GET(), sanitizeNextPath(), createClient(), getUserRole()
...
Cohesion: 0.16
Nodes (14): fetchDesignSystem(), fetchProjectFiles(), createConversation(), createProject(), deleteConversation(), deleteProject(), getTemplate(), importClaudeDesignZip() (+6 more)

### Community 42 - "Community 42"
Cohesion: 0.24
Nodes (18): cleanupPackedWinNamespace(), cleanupWinRegistryResidues(), createEmptyRegistryEntry(), createWinRemovalPlan(), execReg(), installPackedWinApp(), listDirectories(), listPackedWinNamespaces() (+10 more)
...
Cohesion: 0.27
Nodes (6): errorResponse(), GET(), mapErrorStatus(), POST(), requireAuthenticatedUser(), getUserOrdersSummaries()
...
Cohesion: 0.27
Nodes (7): resolveElectronBuilderCliPath(), resolveElectronDistPath(), resolveElectronVersion(), resolveToolPackBuildOutput(), resolveToolPackConfig(), readPackedMacLogs(), readPackedWinLogs()
...
Cohesion: 0.48
Nodes (5): GET(), mapResultStatus(), POST(), getAdminProducts(), searchProductsForNailArt()
...
Cohesion: 0.6
Nodes (4): getAdminOrderById(), getAdminOrdersPaginated(), unwrapUserEmail(), unwrapUserNames()
...
- **Why does `createClient()` connect `Community 21` to `Community 68`, `Community 69`, `Community 7`, `Community 53`, `Community 22`, `Community 60`?**
  _High betweenness centrality (0.313) - this node is a cross-community bridge._
- **Why does `extractSwatches()` connect `Community 74` to `Community 21`?**
  _High betweenness centrality (0.289) - this node is a cross-community bridge._
- **Why does `pick()` connect `Community 21` to `Community 74`?**
  _High betweenness centrality (0.289) - this node is a cross-community bridge._
- **Are the 32 inferred relationships involving `requireAdmin()` (e.g. with `assertAdmin()` and `assertAdmin()`) actually correct?**
