...
function QuoteMark() {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden className="h-7 w-7 text-[#c6a75e]/35">
      ...
      >
        {items.map((t) => (
          <SwiperSlide key={t.id} className="h-auto">
            <figure className="flex h-full flex-col rounded-2xl border border-[#c6a75e]/20 bg-white p-7">
              <QuoteMark />
              <blockquote className="mt-3 flex-1 text-[14.5px] leading-[1.7] text-[#3a3a3a]">
                &ldquo;{t.quote}&rdquo;
              </blockquote>
              <figcaption className="mt-6 flex items-center gap-3.5 border-t border-[#c6a75e]/15 pt-5">
