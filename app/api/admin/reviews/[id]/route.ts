...
export async function PATCH(
  ...
  try {
    ...
    const result = await setReviewApproval(id, body.is_approved)
    if (result.error) {
    ...
    console.error("[api/admin/reviews PATCH] Error inesperado:", err)
...
export async function DELETE(
  ...
  try {
    ...
    console.error("[api/admin/reviews DELETE] Error inesperado:", err)
    return errorResponse("Error interno del servidor", 500)
  }
}
