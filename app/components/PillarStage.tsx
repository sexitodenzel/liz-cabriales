  ...
  return [
    {
      ...
      body: "Distribuidora oficial de Exotic, GMI, Lovely Nails, DNS, Covett, Golden Nails, Miss Nails, Mely Nails, Lúa by Jennifer Preciado, Timantti, Tuttimani, Sweet Natural Spa, Hadria Natural Spa, Ice Nova, Kodi, Liu Nails, NGHIA, aashta, Alfatech+, Clear Zal, Bio Asep, Peyco, Podocare, Staleks Pro, Tecnipie y muchas más marcas con las que buscamos brindarte todo lo que buscas en un solo lugar. Contamos con envíos a todo México.",
    ...
    },
    {
      ...
      headingEm: "vanguardista e innovadora.",
