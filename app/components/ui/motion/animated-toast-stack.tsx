...
const ToastItem = memo(function ToastItem({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "relative overflow-hidden rounded-2xl border border-neutral-200 bg-white/95 p-3 shadow-2xl backdrop-blur-xl",
          classNames?.surface,
        )}
      >
        {renderToast ? (
              ...
              <AnimatePresence mode="popLayout" initial={false}>
                ...
                >
                  ...
                  {toast.description ? (
                    <p
                      className={cn(
                        "mt-0.5 line-clamp-2 text-xs leading-4 text-neutral-500",
