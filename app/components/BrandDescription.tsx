...
export default function BrandDescription({ photoUrl }: Props) {
  ...
  return (
    <section ref={ref} className="text-ink">
        ...
        <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.1fr)] lg:gap-16">
          ...
          <div className={`order-2 flex flex-col lg:order-1 ${fadeUp(inView)}`}>
            <p className="mb-4 inline-flex items-center gap-2.5 text-[11px] font-semibold uppercase tracking-[0.22em] text-gold">
              <span className="h-px w-8 bg-gold-soft" /> Spotlight
            </p>

            <h2 className="max-w-[560px] font-display text-[clamp(30px,4.2vw,52px)] font-medium leading-[1.08] tracking-[-0.01em]">
              <span className="text-ink">¡Te damos la bienvenida a </span>
              <span className="italic text-gold">Liz Cabriales!</span>
            </h2>
            <div className="mb-6 mt-5 h-0.5 w-16 bg-gold-soft" aria-hidden />
            ...
            <div className="max-w-[560px] space-y-4">
              ...
              <p className="font-display text-[17px] italic leading-[1.5] text-gold">
                &ldquo;Piensa, cree, sueña y atrévete.&rdquo;
              </p>

              <div className="space-y-4 pt-1 text-[14px] leading-[1.75] text-ink-soft sm:text-[15px]">
                <p>
          ...
          >
            <div className="relative mx-auto grid w-full max-w-[640px] grid-cols-12 grid-rows-6 gap-3">
              ...
              <div className="relative col-span-8 row-span-6 overflow-hidden rounded-card bg-neutral-100 shadow-[0_18px_50px_rgba(20,20,20,0.18)]">
              ...
              <div className="pointer-events-none absolute -left-3 -top-3 z-10 hidden sm:block">
                <div className="relative">
                  <span className="block h-[88px] w-[88px] rounded-full border border-gold-soft/60 bg-surface shadow-[0_8px_24px_rgba(20,20,20,0.12)]" />
                  <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
                    <span className="text-[8px] font-semibold uppercase tracking-[0.18em] text-gold">
                      Academia
                    </span>
                    <span className="font-display text-[11px] font-medium text-ink">
                      Liz Cabriales
                    </span>
                    <span className="text-[8px] font-semibold uppercase tracking-[0.18em] text-gold">
                      Tampico
            ...
            <Link
              href="/sobre-liz"
              className="mt-5 block text-center text-[12px] font-semibold uppercase tracking-[0.16em] text-gold transition-colors hover:text-ink"
            >
              Ver todas las fotos →
            </Link>
          </div>
