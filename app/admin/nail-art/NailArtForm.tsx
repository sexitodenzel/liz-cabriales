...
type Props = {
  initialData?: Partial<NailArtFormData> & { id?: string }
  onSave: (data: NailArtFormData) => Promise<void>
  onCancel: () => void
  saving: boolean
}
...
export default function NailArtForm({ initialData, onSave, onCancel, saving }: Props) {
  ...
  function handleSearchChange(val: string) {
    ...
    searchTimeout.current = setTimeout(async () => {
      setSearching(true)
      try {
        const res = await fetch(`/api/admin/nail-art/products?q=${encodeURIComponent(val)}`)
    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <input
          ...
          placeholder="Ej. Uñas nude con detalles dorados"
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <input
          ...
          placeholder="unas-nude-doradas"
          className={inputClass}
        />
        {errors.slug && <p className="text-[11px] text-red-500">{errors.slug}</p>}
        <p className="text-[11px] text-neutral-400">URL: /nail-art/<strong>{slug || "…"}</strong></p>
      </div>

      {/* Descripción */}
      <div className="flex flex-col gap-1.5">
        <label className="text-[12px] font-semibold text-neutral-600">Descripción</label>
        <textarea
          value={description}
          onChange={(e) => setDescription(e.target.value)}
          rows={3}
          placeholder="Describe el look, la técnica, o el resultado final…"
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex flex-col gap-2 pt-1">
            ...
            <p className="text-[11px] text-neutral-400">Recomendado: 800×1067 px (3:4)</p>
          </div>
        </div>
      ...
      <div className="flex flex-col gap-3">
        <label className="text-[12px] font-semibold text-neutral-600">Productos que se usaron</label>
              ...
              <div key={lp._key} className="flex items-start gap-3 rounded-xl border border-neutral-100 bg-neutral-50 p-3">
                ...
                <div className="flex flex-1 flex-col gap-1.5 min-w-0">
                  ...
                  <input
                    ...
                    placeholder="¿Para qué se usó? Ej. Base de color, top coat…"
