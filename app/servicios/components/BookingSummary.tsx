...
export default function BookingSummary({
  ...
  return (
    <div
      ...
      className="flex flex-col overflow-hidden rounded-xl border border-neutral-200/80 bg-white/70 p-5 max-lg:min-h-0 lg:h-[calc(100dvh-var(--navbar-actual-h,80px)-4.75rem)] lg:max-h-[calc(100dvh-var(--navbar-actual-h,80px)-4.75rem)]"
    >
      {/* Header */}
