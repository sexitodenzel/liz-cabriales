...
import AccountWelcomeBanner from "./AccountWelcomeBanner"
...
export default async function PerfilPage() {
  ...
  const welcomeName = resolveWelcomeName(profile, user)
  const displayName =
  ...
  return (
    ...
    <AccountShell active="resumen" title="Resumen de cuenta" isAdmin={isAdmin} hideDefaultTitle>

      <AccountWelcomeBanner
        firstName={welcomeName}
        initial={accountInitial(welcomeName)}
      />
      ...
      <div className="mt-10">
        ...
        <p className="mt-1 text-sm text-neutral-500">
          ...
          Tu información y actividad reciente
      ...
      <div className="mt-8 rounded-2xl border border-neutral-200/80 bg-[var(--surface)] p-5 shadow-sm sm:p-6">

        <h3 className="text-lg font-medium text-neutral-900">Pedidos recientes</h3>
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-2xl border border-neutral-200/80 bg-[var(--surface)] p-5 shadow-sm sm:p-6">

          <h3 className="text-lg font-medium text-neutral-900">Datos principales</h3>

          <div className="mt-4 space-y-1 border-t border-neutral-200 pt-4 text-sm text-neutral-800">
            ...
            {memberSince && (
              ...
              <p className="text-neutral-600">Miembro desde {memberSince}</p>
        ...
        <div className="rounded-2xl border border-neutral-200/80 bg-[var(--surface)] p-5 shadow-sm sm:p-6">
          ...
          <h3 className="text-lg font-medium text-neutral-900">Dirección principal</h3>

          <div className="mt-4 border-t border-neutral-200 pt-4 text-sm text-neutral-800">
            ...
            {primaryAddress ? (
              ...
              <p className="text-neutral-600">
                ...
                Aún no tienes una dirección principal. Se guardará al completar tu primer
