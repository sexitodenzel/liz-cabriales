...
export default function StickyCartBar({ product, selectedVariant, triggerRef }: Props) {
  ...
  return (
    <div className="navbar-follow-collapse fixed left-0 right-0 z-40 border-b border-neutral-200 bg-ivory/85 backdrop-blur-md" style={{ top: "var(--navbar-actual-h, 80px)" }}>
