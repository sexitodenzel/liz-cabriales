...
import RetryCoursePaymentButton from "./RetryCoursePaymentButton"
...
export default async function InscripcionErrorPage({
  params,
  searchParams,
}: Props) {
  ...
  const fullPrice = course ? course.price * (result.data?.attendees ?? 1) : 0
  const minDeposit = course ? getMinDeposit(course.price) : 0
      ...
      <div className="mx-auto max-w-[720px]">
        <Breadcrumb
          items={[
            ...
            { label: "Curso", href: `/academia/${courseId}` },
            { label: "Inscripción" },
            { label: "Error" },
          ]}
        />
        <div className="rounded-[28px] border border-[#e7b8b8] bg-[#fff2f2] p-8 shadow-sm">
          ...
          <p className="mt-3 text-sm leading-6 text-neutral-700">
            {isFailure
              ? "MercadoPago no pudo procesar tu pago. Tu inscripción sigue pendiente."
              : "Saliste del proceso de pago antes de completarlo. Tu inscripción sigue pendiente."}
          </p>
        ...
        <div className="mt-6 rounded-[28px] border border-[#e8e1d3] bg-white p-6 shadow-sm sm:p-8">
          ...
          <div className="mt-6 space-y-4">
            {course && (
              <div className="rounded-2xl border border-neutral-200 bg-[#fcfbf8] p-4">
                ...
                <p className="mt-1 text-sm text-neutral-600">
                  Intenta pagar tu inscripción usando otro método.
                </p>
                <div className="mt-4">
            ...
            <div className="rounded-2xl border border-neutral-200 bg-[#fcfbf8] p-4">
              <p className="text-sm font-semibold">Volver al curso</p>
              <p className="mt-1 text-sm text-neutral-600">
                Consulta el curso y las opciones de pago.
              </p>
              <div className="mt-4">
                <Link
